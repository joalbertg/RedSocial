class FriendshipDecorator < Draper::Decorator
  ...
  def confirm_button
    h.link_to 'Aceptar', h.friendship_path(object.user, status: 1),
              method: :patch, class: 'right-space mdl-button
              mdl-js-button mdl-button--raised mdl-button--colored'
  end

  def denegate_button
    h.link_to 'Denegar', h.friendship_path(object.user, status: 0),
              method: :patch, class: 'mdl-button mdl-js-button
